...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className={styles.dashboardPage}>
      <Title level={2} className={styles.dashboardTitle}>Thống kê tổng quan</Title>
      <div className={styles.dashboardStatsGrid}>
        ...
        <Card className={styles.statCard}>
          ...
          <p className={styles.statCardValue}>{stats.totalRevenue.toLocaleString('vi-VN')} VNĐ</p>
        </Card>
      </div>
      ...
      <div style={{ marginTop: '40px' }}>
        ...
        <Title level={3} style={{ marginTop: '20px' }}>Sản phẩm tồn kho thấp</Title>
         <Card>
